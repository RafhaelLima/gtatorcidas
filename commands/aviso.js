...
module.exports = {
    ...
    execute(client, msg, args) {
        ...
        if (!canalnome.startsWith('#') && msg.content.split(' ')[2] != null) { return msg.channel.send(`Você não inseriu o nome do canal. Use o comando da seguinte maneira: \`g!aviso #nomeDoCanal Aviso que você quer. Este comando irá dar @everyone automaticamente.\``); }
        message.splice(0, 1);
        message.splice(0, 1);
